<template>
    <span class="github-tags_tag-used">
        {{tag_name}}
        <span class="github-tags_tag-used_remove" title="Remove this tag" @click.stop="removeTag(tag_id)">
...
.github-tags_tag-used_remove:hover {
    color: #d73a49;
}

.github-tags_tag-used.active {
