<template>
  <div class="" aria-expanded="false" @click="actionButtonClick">
    ...
    <div accept-charset="UTF-8" class="btn-with-count">
      <button type="button" :class="{'btn-primary':saving,'selected':open}" class="btn btn-sm btn-with-count github-tags_action-button" :title="title" :aria-label="title">
